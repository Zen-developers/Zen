...
const superlede = {
	...
	marginTop: '0px',
	margin: '20%',
	fontFamily: 'Univers Pro Extended'
}
...
class Join extends React.Component {
	render() {
		let newHeadline = {
//			logo: {zen},
			slogan: "An online platform where creatives & tastemakers see to be seen."}
		const promo = newHeadline.slogan
		return (
			<div style={{...superlede}}>
				<svg xmlns="http://www.w3.org/2000/svg" width="130" fill="#fff" height="75" viewBox="0 0 101.95 45.489">
...
class Film extends React.Component {
	render() {
		return ( 
			<video autoPlay="autoplay" loop="logo" muted style={video}>
